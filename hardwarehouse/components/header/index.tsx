        ...
        <header>
            <nav className="justify-center text-center items-center">
                <div className="flex bg-[#B3C9E2] items-center justify-around flex-wrap w-full ">
                    ...
                    <div className="flex items-center text-center md:w-36 justify-between gap-[10px] md:gap-[20px]">
                ...
                <div className="flex w-full justify-around items-center bg-[#dfdfdf] py-[4px]">
                    ...
                    <Link href="/admin" className="">
                        <Image
                            ...
                            width={20}
                            height={20}
                            className="md:size-[25px] hover:bg-[#f1f1f1] hover:rounded-[10px] hover:p-1 transition-all duration-300 easy-in-out "
                        />
                    </Link>
                </div>
            </nav>
