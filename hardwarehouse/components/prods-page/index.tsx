    ...
    return (
        <div id="general-wrapper" className="my-2 md:my-4 flex flex-col md:flex-row md:justify-around md:gap-4">
            ...
            <div className="w-full p-4 grid grid-cols-2 md:grid-cols-4 gap-x-2 gap-y-3 md:gap-y-5 justify-items-center overflow-x-auto">
                <ProductCard id={1} nome='NVIDIA RTX 4070' desc="GPU boa demais uai, ruim é o preço" preco={9999.99} imagem="/assets/rtx4070.png"/>
                <ProductCard id={2} nome='NVIDIA RTX 4070' desc="GPU boa demais uai, ruim é o preço" preco={9999.99} imagem="/assets/rtx4070.png"/>
                <ProductCard id={3} nome='NVIDIA RTX 4070' desc="GPU boa demais uai, ruim é o preço" preco={9999.99} imagem="/assets/rtx4070.png"/>
                <ProductCard id={3} nome='NVIDIA RTX 4070' desc="GPU boa demais uai, ruim é o preço" preco={9999.99} imagem="/assets/rtx4070.png"/>
                <ProductCard id={3} nome='NVIDIA RTX 4070' desc="GPU boa demais uai, ruim é o preço" preco={9999.99} imagem="/assets/rtx4070.png"/>
                <ProductCard id={4} nome='NVIDIA RTX 4070' desc="GPU boa demais uai, ruim é o preço" preco={9999.99} imagem="/assets/rtx4070.png"/>
            </div>
        </div>
    )
}